...
public class DataSource : IDisposable {
  ...
  public Layer CreateLayer(string name, SpatialReference srs, wkbGeometryType geom_type, string[] options) {
    IntPtr cPtr = OgrPINVOKE.DataSource_CreateLayer(swigCPtr, name, SpatialReference.getCPtr(srs), (int)geom_type, (options != null)? new OgrPINVOKE.StringListMarshal(options)._ar : null);
    Layer ret = (cPtr == IntPtr.Zero) ? null : new Layer(cPtr, ThisOwn_false());
    if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
