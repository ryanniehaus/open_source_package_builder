...
public int ExportToWkb( byte[] buffer, wkbByteOrder byte_order ) {
  ...
  public Geometry(wkbGeometryType type, string wkt, int wkb, IntPtr wkb_buf, string gml) : this(OgrPINVOKE.new_Geometry((int)type, wkt, wkb, wkb_buf, gml), null) {
    if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public Geometry Clone() {
    ...
    Geometry ret = (cPtr == IntPtr.Zero) ? null : new Geometry(cPtr, ThisOwn_true());
    if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public SpatialReference GetSpatialReference() {
    ...
    SpatialReference ret = (cPtr == IntPtr.Zero) ? null : new SpatialReference(cPtr, ThisOwn_true());
    if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
