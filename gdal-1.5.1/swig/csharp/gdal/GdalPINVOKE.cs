...
class GdalPINVOKE {
  ...
  public static extern int Dataset_ReadRaster(HandleRef jarg1, int jarg2, int jarg3, int jarg4, int jarg5, IntPtr jarg6, int jarg7, int jarg8, int jarg9, int jarg10, int jarg11, int jarg12, int jarg13);

  [DllImport("gdal_wrap", EntryPoint="CSharp_Dataset_WriteRaster")]
  public static extern int Dataset_WriteRaster(HandleRef jarg1, int jarg2, int jarg3, int jarg4, int jarg5, IntPtr jarg6, int jarg7, int jarg8, int jarg9, int jarg10, int jarg11, int jarg12, int jarg13);
  ...
  [DllImport("gdal_wrap", EntryPoint="CSharp_TermProgress_nocb")]
  public static extern int TermProgress_nocb(double jarg1, string jarg2, HandleRef jarg3);

  [DllImport("gdal_wrap", EntryPoint="CSharp_TermProgress_get")]
  public static extern IntPtr TermProgress_get();
  ...
  public static extern int ReprojectImage(HandleRef jarg1, HandleRef jarg2, string jarg3, string jarg4, int jarg5, double jarg6, double jarg7);
  ...
  [DllImport("gdal_wrap", EntryPoint="CSharp_ColorTableUpcast")]
  public static extern IntPtr ColorTableUpcast(IntPtr objectRef);

  [DllImport("gdal_wrap", EntryPoint="CSharp_RasterAttributeTableUpcast")]
  public static extern IntPtr RasterAttributeTableUpcast(IntPtr objectRef);
}
